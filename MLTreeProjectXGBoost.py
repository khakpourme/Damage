...
# gsearch1 = GridSearchCV(estimator = xgb_model, param_grid = parameters_for_testing, n_jobs=-1, iid=False, verbose=10,
...
for train_index, test_index in kf.split(x):
    ...
    # xgb_model.fit(important_train_features, y_train);
    # # Make predictions on test data
    # predictions = xgb_model.predict(important_test_features)
    # # Performance metrics
    # errors = abs(predictions - y_test)
    ...
    # pca.fit(important_train_features)
    # print ("No. of PCs:", pca.n_components_)
    # x_train = pca.transform(important_train_features)
    # x_test = pca.transform(important_test_features)
    #
    # xgb_model.fit(x_train, y_train)
    # # Make predictions on test data
    # predictions = xgb_model.predict(x_test)
